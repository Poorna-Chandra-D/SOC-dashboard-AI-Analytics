...
DROP POLICY IF EXISTS "Users can view own incident responses" ON incident_responses;
DROP POLICY IF EXISTS "Admins can view all incident responses" ON incident_responses;
