...
DROP POLICY IF EXISTS "Users can view SIEM configs" ON siem_configs;
DROP POLICY IF EXISTS "Admins can manage SIEM configs" ON siem_configs;
DROP POLICY IF EXISTS "Engineers can manage integrations" ON external_integrations;
